...
export default function HeroSection() {
	return (
		<div className="heroContainer px-0 py-14 text-center md:px-0 md:py-14 lg:pb-14 lg:pt-[3.1rem] lg:px-0">
			<div className="relative bg-cover bg-no-repeat bg-top h-[560px] mb-[300px] md:mb-[225px] md:px-12 md:pt-[75px] lg:px-20 lg:pt-[100px] lg:mb-[300px]">
				<HeroVectorSvg className="absolute inset-0 w-full h-full -z-10" />
