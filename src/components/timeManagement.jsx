	...
	return (
		<>
			<div className="timeManagementBoundary mt-32">
				...
				<div className="shadowClass bg-white rounded-[2rem] mt-[55px] ml-[181px] w-[1075px] h-[455px] text-black">
					<BlurIn
						word="Attendenct List"
						className="pt-[28px] pl-[30px] text-24px font-bold leading-20px montseratFont tracking-[-1px]"
					/>
